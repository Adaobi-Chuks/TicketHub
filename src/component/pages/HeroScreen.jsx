  ...
  return (
    <section id="home" className="min-h-screen  flex  md:flex-row grid-col-2 items-center justify-center">
      ...
      <div className='md:w-[40rem]'>
        ...
        <button className='flex items-center justify-center mt-10 bg-gradient-to-r from-cyan-500 to-blue-500  w-[10rem] h-[3rem] text-[#0D2986] font-semibold rounded-md text-center'>Get Stared</button>
      </div>
