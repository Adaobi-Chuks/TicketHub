...
const HeroScreen = () => {
  return (
    <section id="home" className="min-h-screen  flex  md:flex-row pt-10 grid-col-2 items-center justify-center">
      ...
      <div className='max-w-full mx-auto grid md:grid-cols-2  px-10 justify-between items-center  pt-[4rem]'>
      <div className='md:w-[40rem]'>
        ...
        <img src={IMG1}  alt='' className="md:w-[35rem] h-[35rem] object-contain"/>
      </div>
